    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          >
            Dự án đã <span className="highlight-orange">bàn giao</span> thành công
          </h2>
              ...
              <div className="portfolio-card shadow-card hover:shadow-card-hover transition-shadow duration-300">
                ...
                <div className="overlay">
                  <div className="w-full">
                    <span
                      className={`text-xs font-bold px-3 py-1 rounded-full mb-2 inline-block ${item.tagColor}`}
                    >
                      {item.tag}
                    </span>
                    <h3 className="font-display font-bold text-white text-lg">{item.title}</h3>
                    <p className="mt-2 inline-flex rounded-full bg-white/15 px-3 py-1 text-xs font-bold text-white">
                      {item.result || 'Tăng lead từ website'}
                    </p>
                    <button
        ...
        <div className="text-center mt-10">
          <button className="btn-secondary" aria-label="Xem tất cả portfolio">
